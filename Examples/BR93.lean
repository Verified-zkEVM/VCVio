...
/-- Shared implementation of the BR93 random-oracle world: the left component forwards uniform
...
abbrev roQueryImpl :
  ...
  unifFwdImpl (Rand →ₒ M) +
    (randomOracle : QueryImpl (Rand →ₒ M) (StateT ((Rand →ₒ M).QueryCache) ProbComp))
