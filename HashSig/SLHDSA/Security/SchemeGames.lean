...
because moving them would leave the two selectors behind as this module's sole SLH-DSA content.
None of the eight mentions an SLH-DSA type; the target file, if they move, is
