...
- `Extern/Falcon/NonVacuity.lean`: a degree-one instance witnessing that the security theorems' hypotheses are jointly satisfiable; it sits under `Extern/` because it consumes the FFI-backed concrete instance.
