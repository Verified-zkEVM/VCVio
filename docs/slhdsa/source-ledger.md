...
| primary/evidence | VCVio | repair base git `7b77e700b3d24a6ab94ed741a650954bbd90859a` | Invalidated S02 implementation retained only as exact repair input; active 43-file SLH-DSA source-tree composite pinned separately |
...
The VCVio composite is specifically SHA-256 of the 43-line GNU `sha256sum` manifest produced, in
