...
Sum and dependent-sum signatures have canonical response-preserving inclusions. The public query
equations expose their action for rewriting without unfolding instance implementation details.
-/
