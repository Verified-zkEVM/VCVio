...
theorem evalDist_mOfFn_uniformOn_pi [Finite α] (n : ℕ) (g : Fin n → m α)
...
space. -/
theorem evalDist_mOfFn_const_uniform [Finite α] (n : ℕ) (mx : m α)
...
their product set. -/
theorem evalDist_mPi_uniformOn_pi [Finite α] (f : ι → m α)
...
product space. -/
theorem evalDist_mPi_const_uniform [Finite α] (mx : m α)
    (h : 𝒟[mx] = uniformOn Set.univ) :
